...
const createDefaultPatch = (): Patch => ({
  ...
  modules: [
    ...
    },
    {
      ...
      type: 'filter',
      parameters: {
        cutoff: 0.004545454545454545,
        resonance: 0.47272727272727233,
        drive: 0,
        cutoffCvAmt: 1,
        resCvAmt: 1,
        driveCvAmt: 1,
  ...
  connections: [
    ...
    {
      id: '573184e9-6ada-487b-a431-0c8eede69496',
      from: 'oscillator-1-audio-out',
      to: 'svf-filter-1-audio-in',
      kind: 'audio',
      color: '#ff33ef',
    },
    {
      id: 'b83a6160-d099-4b6a-bb08-09ddb87d6a1c',
      from: 'adsr-1-env-out',
      to: 'svf-filter-1-cutoff-cv-in',
      kind: 'cv',
      color: '#FF8000',
    },
    {
      id: 'f846ead1-1e30-4eab-b90d-6dcc98e72eae',
      from: 'oscillator-1-audio-out',
      to: 'filter-1-audio-in',
      kind: 'audio',
      color: '#ff33ef',
    },
    {
      id: '163bc3a0-52ba-48ed-81d3-54fb0551048d',
      from: 'filter-1-lp-out',
      to: 'vca-1-audio-in',
      kind: 'audio',
      color: '#FF8000',
    },
    {
      id: '57331158-c51b-4334-8bad-1ca0f1c5dc1e',
      from: 'adsr-1-env-out',
      to: 'filter-1-cutoff-cv-in',
      kind: 'cv',
      color: '#FF8000',
    },
  ],
  metadata: {
    ...
    modified: '2025-09-08T00:52:59.861Z',
    description:
