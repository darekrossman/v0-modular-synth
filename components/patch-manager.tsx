...
const createDefaultPatch = (): Patch => ({
  ...
  modules: [
    ...
    },
    {
      ...
      parameters: {
        cutoff: 0,
        resonance: 0.01818181818181818,
        drive: 0,
        cutoffCvAmt: 0.7727272727272734,
        resCvAmt: 1,
        driveCvAmt: 1,
      },
      rack: 1,
  ...
  connections: [
    ...
    {
      id: '27635a58-50d9-4802-ac59-e9b6798a4119',
      from: 'svf-filter-1-lp-out',
      to: 'vca-1-audio-in',
      kind: 'audio',
      color: '#4db500',
    },
    {
      id: 'e3c60e56-d9bd-4569-b9e0-a4ee9f7943c0',
      from: 'svf-filter-1-lp-out',
      to: 'scope-1-ch1-in',
      kind: 'audio',
      color: '#4db500',
  ...
  metadata: {
    ...
    modified: '2025-09-07T22:46:25.170Z',
    description:
