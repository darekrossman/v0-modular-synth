            ...
            <div className="flex h-full">
              ...
              {([0, 2, 4, 5, 7, 9, 11] as number[]).map((semitone) => {
                ...
                return (
                  <div
                    key={semitone}
                    className={`w-4 flex-1 border-r border-black/30 last:border-r-0 cursor-pointer select-none ${on ? 'bg-blue-300' : 'bg-neutral-100 hover:bg-neutral-200'
                      }`}
                    onClick={() => {
            ...
            <div className="absolute top-0 left-0 h-6 w-full pointer-events-none">
              ...
              {(
                ...
                return (
                  <div
                    key={semitone}
                    className={`absolute h-full pointer-events-auto cursor-pointer rounded-[2px] border ${on
