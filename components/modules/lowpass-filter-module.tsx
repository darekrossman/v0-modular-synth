    ...
    <ModuleContainer title="Filter" moduleId={moduleId}>
      <div className="flex flex-col items-center justify-center gap-4 mt-3">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="flex gap-2">
            <Knob
              value={input1Level}
              onValueChange={setInput1Level}
              size="sm"
              data-param="input1Level"
              label="IN 1"
            />
            <Knob
              value={input2Level}
              onValueChange={setInput2Level}
              size="sm"
              data-param="input2Level"
              label="IN 2"
            />
            <Knob
              value={input3Level}
              onValueChange={setInput3Level}
              size="sm"
              data-param="input3Level"
              label="IN 3"
            />
          </div>
        </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between items-end gap-2">
          <Port
            id={`${moduleId}-audio-in-1`}
            type="input"
            label="IN 1"
            audioType="audio"
            audioNode={in1Ref.current ?? undefined}
          />
          <Port
            id={`${moduleId}-audio-in-2`}
            type="input"
            label="IN 2"
            audioType="audio"
            audioNode={in2Ref.current ?? undefined}
          />
          <Port
            id={`${moduleId}-audio-in-3`}
            type="input"
            label="IN 3"
            audioType="audio"
            audioNode={in3Ref.current ?? undefined}
          />
        </div>
        <div className="flex justify-between items-end gap-2">
          <Port
